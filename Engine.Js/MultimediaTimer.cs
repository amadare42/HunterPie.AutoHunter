...
namespace Engine.Js
{
    // source: https://stackoverflow.com/questions/24839105/high-resolution-timer-in-c-sharp
    public class MultimediaTimer : IDisposable
    {
        ...
        public MultimediaTimer(bool isPeriodic)
        {
        ...
        public void Start()
        {
            ...
            UInt32 userCtx = this.IsPeriodic ? 1u : 0u;
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern UInt32 TimeSetEvent(UInt32 msDelay, UInt32 msResolution,
            MultimediaTimerCallback callback, ref UInt32 userCtx, UInt32 eventType);
